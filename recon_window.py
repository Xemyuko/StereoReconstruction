...
def start_recon(main_window):
    ...
    def help_window():
        ...
        def on_close():
            ...
            help_win_state = False
            help_disp.destroy()
        help_text = tk.Text(help_disp, width=70, height=10)
        ...
        help_text.pack()
    #tk.Button(recon, text = 'Help', command = toggle_help_window).grid(sticky="W",row = 10, column = 5)
    ...
    cal_btn = tk.Button(recon, text = "Camera Calibration", command = toggle_cal_window)
